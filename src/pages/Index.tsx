...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[600px] flex items-center h-screen">
        <div 
        ...
        <div className="container mx-auto px-4 text-center relative z-10 py-20">
          ...
          <div className="flex gap-4 justify-center">
            ...
            <Link to="/create-listing">
              <Button size="lg" variant="outline" className="bg-white/6 text-white border-white/50 hover:bg-white/0">
                Start Selling
              </Button>
            </Link>
          </div>
